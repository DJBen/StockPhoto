...
public enum HTTPError: LocalizedError, Equatable {
    ...
    public var errorDescription: String? {
        ...
        case .badRequest:
            return NSLocalizedString(
                "HTTPError.BadRequest.description",
                value: "There was a problem with the request.",
                comment: "Bad request"
            )
        case .unauthorized:
            return NSLocalizedString(
                "HTTPError.Unauthorized.description",
                value: "You don't have permission to access this.",
                comment: "Unauthorized"
            )
        case .forbidden:
            return NSLocalizedString(
                "HTTPError.Forbidden.description",
                value: "Access to this resource is not allowed.",
                comment: "Forbidden"
            )
        case .notFound:
            return NSLocalizedString(
                "HTTPError.NotFound.description",
                value: "The requested item could not be found.",
                comment: "Not found"
            )
        case .internalServerError:
            return NSLocalizedString(
                "HTTPError.InternalServerError.description",
                value: "There was a problem on our end. We're working to fix it.",
                comment: "Internal server error"
            )
        case .unknownError:
            return NSLocalizedString(
                "HTTPError.UnknownError.description",
    ...
    public var recoverySuggestion: String? {
        ...
        case .notFound:
            return NSLocalizedString("HTTPError.NotFound.recovery", value: "Please try again later.", comment: "Not found recovery")
        case .internalServerError:
